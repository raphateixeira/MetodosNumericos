...
**Interpolação:** a curva passa por **todos** os pontos (ver Aula 3). Adequada a dados precisos.
...
3. Ajuste um polinômio de grau 2 e de grau 5 ao mesmo conjunto ruidoso e discuta **sobreajuste**.
4. Compare o ajuste polinomial (mínimos quadrados) com a interpolação (Aula 3) para o mesmo conjunto de dados ruidosos: qual captura melhor a tendência?
