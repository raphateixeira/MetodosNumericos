...
📓 [Notebook complementar](../Aplicacoes/MassaMolaAmortecedor.ipynb) — sistema de 2ª ordem forçado, comparando Euler explícito e `solve_ivp` (ver também a aula CN08, sobre sistemas).
